 ...
 *
 */
public class OutputFrameControllerBot {
    @FXML
    ...
    private boolean isBotFirst = true;
    // private Bot bot;
    private Bot XBot, OBot;
    ...
    private void selectedCoordinates(int i, int j){
        ...
        if (!this.buttons[i][j].getText().equals("") && !playerXTurn)
        ...
        // Button must be blank.
            ...
            if (this.playerXTurn) {
                ...
                Action botMove = XBot.move(new State(this.buttons, this.isBotFirst));
                i = botMove.i;
                j = botMove.j;
    ...
    private void moveBot(Bot bot) {
        Action botMove = bot.move(new State(this.buttons, this.isBotFirst));
        int i = botMove.i;
        int j = botMove.j;
